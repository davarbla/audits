...
A time-boxed security review of the **open-dollar/od-relayer** repository was done by **Davarbla Consulting Audit Group**, with a focus on the security aspects of the application's smart contracts implementation.
