...
A time-boxed security review of the **limit-order-protocol** and **limit-order-settlement** repository was done by **Davarbla Consulting Audit Group**, with a focus on the security aspects of the application's smart contracts implementation.
